...
func (sa *TextSelfAttention) Forward(ctx ml.Context, hiddenState, positions, _ ml.Tensor, cache model.Cache, opts *TextModelOptions) ml.Tensor {
	...
	key, value, mask := cache.Put(ctx, key, value, cache.Options)
...
func (d *TextSelfAttentionDecoderLayer) Forward(ctx ml.Context, hiddenState, positions, mask, _, _ ml.Tensor, cache model.Cache, _ *cache.TensorCache, opts *TextModelOptions) ml.Tensor {
...
func (ca *TextCrossAttention) Forward(ctx ml.Context, hiddenState, crossAttentionStates ml.Tensor, _ model.Cache, tCache *cache.TensorCache, opts *TextModelOptions) ml.Tensor {
	batchSize := hiddenState.Dim(1)
	headDim := opts.hiddenSize / opts.numHeads
...
func (d *TextCrossAttentionDecoderLayer) Forward(ctx ml.Context, hiddenState, _, _, crossAttentionStates, crossAttentionMask ml.Tensor, cache model.Cache, tCache *cache.TensorCache, opts *TextModelOptions) ml.Tensor {
	d.run = true
...
type TextDecoderLayer interface {
	Forward(ctx ml.Context, hiddenState, positionIDs, mask, crossAttentionStates, crossAttentionMask ml.Tensor, cache model.Cache, tCache *cache.TensorCache, opts *TextModelOptions) ml.Tensor
	Run() bool
}
...
func (d *TextDecoder) Forward(ctx ml.Context, hiddenState, positionIDs, mask, crossAttentionStates, crossAttentionMask ml.Tensor, cache model.Cache, tCache *cache.TensorCache, opts *TextModelOptions) ml.Tensor {
...
func (m *TextModel) Forward(ctx ml.Context, inputIDs, positionIDs, mask, crossAttentionStates, crossAttentionMask ml.Tensor, cache model.Cache, tCache *cache.TensorCache) ml.Tensor {
